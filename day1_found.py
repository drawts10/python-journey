"""
Day 01: variables, data types, and basic operations
...
# A variable should not be identified with one letter
x = 26

# A variable a name that clearly indicates its intended use 
user_age = 26
